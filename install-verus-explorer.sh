...
# only accept VRSC as argument by hard coding
ac=VRSC
...
cd ${ac}-explorer
$CUR_DIR/node_modules/bitcore-node-komodo/bin/bitcore-node install git+https://git@github.com/VerusCoin/insight-api-komodo git+https://git@github.com/VerusCoin/insight-ui-komodo
cd $CUR_DIR
